...
const buttonVariantClass: Record<ButtonVariant, string> = {
  primary:
    'border-accent-blue bg-accent-blue text-[#11131f] hover:border-accent-blue/80 hover:bg-accent-blue/90',
  ...
  ghost:
    'border-transparent bg-transparent px-0 py-0 text-text-tertiary hover:translate-y-0 hover:text-text-secondary',
};
