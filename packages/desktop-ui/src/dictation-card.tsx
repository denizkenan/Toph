...
export function DictationCard({
  ...
  const statusLabel =
    pasteStatusLabel[conversion.pasteStatus] ?? conversion.pasteStatus;
  const statusTone =
    pasteStatusTone[conversion.pasteStatus] ?? "text-text-tertiary";
  ...
  return (
    <Collapsible.Root defaultOpen={false}>
      ...
      >
        ...
        {/* Transcript preview: click to expand */}
        <Collapsible.Trigger
