...
import { SHORTCUT_PRESETS } from '@shared/contracts'
      ...
      <section className="settings-simple">
        <header className="panel simple-header">
          ...
          <div className="simple-header-actions">
            ...
            <button className="primary-button" onClick={() => void window.toph.toggleCapture()}>
              {primaryActionLabel}
            </button>
            <button className="secondary-button" onClick={() => void window.toph.hideSettings()}>
              Hide to tray
            </button>
          </div>
        </header>
          ...
          <article className="panel settings-card">
            ...
            <div className="field-actions">
              <button
                ...
                onClick={() => void window.toph.installShortcut(selectedPresetId)}
